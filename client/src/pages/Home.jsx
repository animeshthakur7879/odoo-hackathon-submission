...
//     <div
//       onClick={(e) => handleClick(question)}
//       className={`group relative bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 p-6 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-200/50 hover:-translate-y-1 cursor-pointer ${
//         hoveredCard === index ? 'shadow-2xl shadow-blue-500/10 scale-[1.02]' : 'shadow-lg'
//       }`}
//       onMouseEnter={() => setHoveredCard(index)}
//       onMouseLeave={() => setHoveredCard(null)}
...
//                 {question?.postedBy?.email?.charAt(0).toUpperCase() || 'U'}
//               </div>
//               <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full flex items-center justify-center">
//                 <Star className="w-2.5 h-2.5 text-white" />
//               </div>
